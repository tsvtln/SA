...
' *******************************************************************
' * Adapt this script for use with your own network and printer   ***
' * Read all comments.                                            ***
' *******************************************************************
' *******************************************************************
' * Section 1 will contain all the message box and title bar text ***
' * Section 2 will contain the Welcome box Sub                    ***
' * Section 3 will contain the Install_All_Printers Sub           ***
' * Section 4 will contain the Install_each_Printer Sub           ***
' * Section 5 will contain the End_Program Sub                    ***
' *******************************************************************
' *******************************************************************
' ************** Section 1           ********************************
' ************** Begin Message Boxes ********************************
