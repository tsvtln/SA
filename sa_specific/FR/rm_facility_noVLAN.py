...
# Be sure to verify that the facility is no longer associated with any user groups or device
# groups and that there are no managed servers that reference the facility.
...
#userInput = input('Enter Opsware SAS Facility ID:' + '\n')
delete = datacenter_deleteEntire(spin, 50)
datacenter_deleteEntire(spin, 50)
