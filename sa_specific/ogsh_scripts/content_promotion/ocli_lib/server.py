...
class Server:
	...
	def getLifecycle(self):
		self.lifecycle = open(os.path.join(self.dir, "attr/opswLifecycle")).read()
		return self.lifecycle

	def provisionServer(self, os_sequence_name):
		print "This is not implemented currently, as pool servers do not appear in the OGSH"
		return
