#!/bin/sh
###################################################
# Script Name - FindByProcessName.sh
# Function - Check to see if a process is running on a machine
# Argument - Process Name as a Sting
...
ARG_LIST=$1
SCRIPT_NAME=CheckProcessByName
...
if  [ "x$ARG_LIST" == "x" ];
then
        echo "Missing argument: Please pass the process name"
        exit 1
fi
