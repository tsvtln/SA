...
self.wfile.write("dc_cache.my_dc_id: %s\n" % dc_cache.my_dc_id)

self.wfile.write("alias_dict: %s\n" % pprint.pformat(cache.alias_dict))

self.wfile.write("cache_dict: %s\n" % pprint.pformat(cache.cache_dict))
