...
sys.path.extend(['/lc/blackshadow', '/cust/usr/blackshadow', '/cust/usr/blackshadow/spin', '/lc/blackshadow/coglib', '/opt/opsware/pylibs', '/opt/opsware', '/opt/opsware/spin', '/opt/opsware/pylibs/coglib'])
